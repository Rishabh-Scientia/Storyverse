...
import { Lock, Mail, Sparkles, Loader2, ArrowRight } from "lucide-react";
              ...
              <div className="flex items-center justify-between">
                ...
                <div className="text-xs">
                  <a
                    ...
                    onClick={(e) => {
                      e.preventDefault();
                      alert("Password reset simulated. Check console or use credential login.");
                    }}
                    className="font-semibold text-violet-650 dark:text-violet-400 hover:underline"
                  >
                    Forgot password?
                  </a>
                </div>
